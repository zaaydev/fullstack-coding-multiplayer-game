                        ...
                        <div className="flex items-center gap-6">
                            ...
                            <div className="flex items-center gap-3 bg-white/5 px-5 py-2 rounded-xl border border-white/10">
                                ...
                                <div>
                                    ...
                                    <p className="text-xl font-bold text-yellow-400">{gameInfo.points}</p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-center gap-3 bg-white/5 px-5 py-2 rounded-xl border border-white/10">
                                ...
                                <div>
                                    ...
                                    <p className="text-xl font-bold text-blue-400">{gameInfo.round}</p>
                                </div>
                            </div>
                    ...
                    <div className="flex items-start gap-4 mb-6">
                        ...
                        <div className="flex-1">
                            <div className="flex items-center gap-3 mb-3">
                                <h2 className="text-sm font-semibold text-gray-400 uppercase tracking-wider">Challenge</h2>
                                <span className="bg-blue-400/20 text-blue-400 px-3 py-1 rounded-full text-xs font-bold">
                                    Round {gameInfo.round}
                                </span>
                            </div>
                            <p className="text-3xl font-bold leading-relaxed">{gameInfo.question}</p>
                        </div>
                    </div>
                    ...
                    <div className="flex items-center justify-between pt-6 border-t border-white/10">
                        <div className="flex items-center gap-6">
                            ...
                            <div className="text-sm text-gray-400">
                                Difficulty: <span className="text-yellow-400 font-semibold">Medium</span>
                            </div>
                        </div>
                        <div className="text-sm text-gray-400">
                            Current Points: <span className="text-yellow-400 font-bold text-lg">{gameInfo.points}</span>
                        </div>
                    </div>
                </div>
                ...
                <div className="bg-gradient-to-br from-[#09090B] to-[#1a1a19] rounded-2xl border border-white/10 p-8 shadow-2xl">
                    <div className="flex items-center justify-between mb-6">
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <button className="px-6 py-2 bg-gradient-to-r from-green-600 to-green-700 hover:from-green-500 hover:to-green-600 rounded-lg text-sm font-bold uppercase tracking-wider shadow-lg shadow-green-900/50 transition-all duration-300" onClick={runCode}>
                                Run Code
                            </button>
