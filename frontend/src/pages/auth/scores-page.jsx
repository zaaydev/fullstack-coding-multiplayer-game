                  ...
                  <div className="p-5">
                    ...
                    <div className="flex items-start justify-between gap-4">
                      ...
                      <div className="flex items-center gap-3 min-w-0">
                        <span className={`text-xl font-bold shrink-0 ${rank.color}`}>
                          {rank.emoji}
                        </span>
                        <div className="min-w-0">
                          ...
                          {s.completed_in && (
                            <p className="text-[10px] text-zinc-600 font-mono mt-0.5">
                              completed in{" "}
                              <span className="text-zinc-400">{s.completed_in}</span>
                            </p>
                          )}
                      ...
                      <div className="flex-shrink-0 flex items-baseline gap-0.5">
                        <span className={`text-3xl font-black font-mono tabular-nums ${getScoreColor(score)}`}>
                          {score}
                        </span>
                        <span className="text-zinc-700 text-sm">/10</span>
                      </div>
                    </div>
